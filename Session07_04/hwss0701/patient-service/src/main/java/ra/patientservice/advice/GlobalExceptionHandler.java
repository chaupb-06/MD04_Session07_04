...
import ra.patientservice.dto.response.ApiResponseError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponseError<?>> handleHttpMessageNotReadableException(MethodArgumentNotValidException ex) {
